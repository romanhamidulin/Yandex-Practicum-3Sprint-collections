package HashTables.operations.task1;
...
public class Practicum {
    public static void main(String[] args) {
        HashMap<String, Integer> musicGroups = new HashMap<String, Integer>();  // объявите и проиницализируйте хеш-таблицу musicGroups
        ...
        for (int i=0;i< musicGroups.size();i++){
            String group = musicGroups.keySet().toArray()[i].toString();
